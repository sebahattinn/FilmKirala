...
namespace FilmKirala.Infrastructure.Migrations
{
    ...
    [Migration("20260331074530_AddPasswordPolicyFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmKirala.Domain.Entity.NotificationLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmKirala.Domain.Entity.Rental", b =>
                {
                    ...
                    b.HasIndex("Status", "EndRentalDate")
            ...
            modelBuilder.Entity("FilmKirala.Domain.Entity.RentalPricing", b =>
                {
                    ...
                    b.HasIndex("MovieId", "DurationType")
                        .IsUnique();

                    b.ToTable("RentalPricings");
                });

            modelBuilder.Entity("FilmKirala.Domain.Entity.ReportJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmKirala.Domain.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime?>("PasswordWarningSentAt")
                        .HasColumnType("datetime2");
