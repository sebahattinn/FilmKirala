    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalPricings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RentalPricings_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalPricingId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rentals_RentalPricings_RentalPricingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_RentalPricingId",
                table: "Rentals",
