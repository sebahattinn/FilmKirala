...
namespace FilmKirala.Application.Interfaces.Services
{
    ...
    {
        Task RentMovieAsync(RentRequestDto request, int userId); // UserId token'dan gelecek ve kullanıcının film kiralayabilmesi için tüm kontrolleri burası yapacak
